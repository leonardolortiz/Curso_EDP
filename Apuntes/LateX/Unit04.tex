...
\begin{document}
	...
	\begin{frame}{Bit Accurate Data Types}
		...
		Hasta la fecha, existen dos tipos de datos de precisión bit a bit estándar en la industria: \textbf{SystemC} y los tipos de datos \textbf{Algorithmic C} de Mentor Graphics. \newline
		
		\footnotesize
		\url{http://www.mentor.com/products/esl/high_level_synthesis/ac_datatypes}
		\note{
